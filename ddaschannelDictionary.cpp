...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ddaschannel*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ddaschannel", ::ddaschannel::Class_Version(), "ddaschannel.h", 37,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::DDASEvent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("DDASEvent", ::DDASEvent::Class_Version(), "DDASEvent.h", 16,
...
"/usr/opt/root/root-6.18.04/include",
"/user/e20019/root_analysis/develop/ddas2root_dev/createEvents_2021_09/",
0
    };
